    ...
    <div className='w-full bg-white border-b border-[var(--border-color)] sticky top-0 z-[100]'>
      <div className='  px-4 md:px-4 py-3 flex items-center justify-between gap-4'>
        ...
        <div onClick={() => navigate(paths.home)} className='flex-shrink-0 cursor-pointer'>
          ...
          <h1 className='text-2xl font-extrabold text-gray-800 italic'>BazarBuddy</h1>
        </div>
        ...
        <div className='hidden md:flex flex-1 max-w-xl relative'>
          ...
          >
            ...
            <Button1 type="submit" className='!py-2 !px-5 !text-sm !rounded-lg !font-medium'>Search</Button1>
          </form>
              ...
              <>
                ...
                <div className="absolute top-[120%] right-0 w-48 bg-white border border-gray-100 rounded-xl shadow-xl z-50 py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2 cursor-pointer text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center gap-2"
                  >
                    <BsPerson size={16} />
                    Your Profile
                  </button>
                  <button
                    ...
                    className="w-full text-left px-4 py-2 cursor-pointer text-sm text-red-600 hover:bg-red-50 transition-colors flex items-center gap-2"
                  >
                    <BsXLg size={14} />
                    Sign Out
                  </button>
