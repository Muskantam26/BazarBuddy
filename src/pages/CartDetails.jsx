...
const CartDetails = () => {
  ...
  const { items: cartItems, loading: reduxLoading } = useSelector((state) => state.cart);
              ...
              <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
                ...
                <div className="divide-y divide-gray-50">
                  {cartItems.map((item, index) => {
                    ...
                    return (
                      <div key={item._id || productId || `cart-detail-${index}`} className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-gray-50 transition-colors">
                        {/* Product Info */}
